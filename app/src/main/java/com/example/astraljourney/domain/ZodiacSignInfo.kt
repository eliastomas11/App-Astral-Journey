...
import com.example.astraljourney.R
    ...
    object Taurus: ZodiacSignInfo(R.string.taurus_zodiac_name,ZodiacModel.Tauro)
    ...
    object Scorpio: ZodiacSignInfo(R.string.scorpio_zodiac_name, ZodiacModel.Escorpio)
    object Sagittarius: ZodiacSignInfo(R.string.sagittarius_zodiac_name, ZodiacModel.Sagitario)
    object Capricorn: ZodiacSignInfo(R.string.capricorn_zodiac_name, ZodiacModel.Capricornio)
    object Aquarius: ZodiacSignInfo(R.string.aquarius_zodiac_name, ZodiacModel.Acuario)
    object Pisces: ZodiacSignInfo(R.string.pisces_zodiac_name, ZodiacModel.Piscis)
}
